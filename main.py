...
#     'a2': [('-', '-'), ('a1', 'w2'), ('-', '-'), ('a8', 'w2'), ('-', '-'), ('a2', 'w1'), ('-', 'w1')],
#     'a3': [('a7', 'w1'), ('a7', '-'), ('-', '-'), ('-', '-'), ('-', '-'), ('-', '-'), ('a4', '-')],
#     'a4': [('a5', 'w1'), ('a1', 'w2'), ('a4', 'w1'), ('-', '-'), ('a3', 'w2'), ('-', '-'), ('-', '-')],
#     'a5': [('a7', '-'), ('-', 'w2'), ('a7', '-'), ('a8', '-'), ('-', 'w2'), ('a2', 'w1'), ('-', '-')],
#     'a6': [('a7', '-'), ('a7', '-'), ('a4', 'w2'), ('a1', 'w1'), ('a3', 'w2'), ('a1', '-'), ('a4', 'w2')],
#     'a7': [('-', '-'), ('-', '-'), ('a7', 'w1'), ('a3', 'w2'), ('a4', '-'), ('-', 'w2'), ('-', '-')],
#     'a8': [('-', '-'), ('-', '-'), ('a7', '-'), ('a3', 'w2'), ('a4', 'w2'), ('-', '-'), ('a2', 'w1')],
# }
table = {
    'a1': [('a5', '-'), ('a1', 'w1'), ('-', '-'), ('-', '-')],
    'a2': [('-', '-'), ('a6', '-'), ('-', 'w1'), ('-', '-')],
